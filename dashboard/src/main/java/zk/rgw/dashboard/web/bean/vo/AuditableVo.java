...
public abstract class AuditableVo extends TimeAuditableVo {
    ...
    protected UserVo createdBy;

    protected UserVo lastModifiedBy;

    public void copyOperatorAuditableInfo(OperatorAuditable<User> operatorAuditable) {
        this.createdBy = new UserVo().initFromPo(operatorAuditable.getCreatedBy());
        this.lastModifiedBy = new UserVo().initFromPo(operatorAuditable.getLastModifiedBy());
    }
