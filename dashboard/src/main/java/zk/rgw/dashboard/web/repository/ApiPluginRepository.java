...
public class ApiPluginRepository extends BaseAuditableEntityMongodbRepository<ApiPlugin> {

    public ApiPluginRepository(MongoClient mongoClient, MongoDatabase database) {
